...
export class GeoService {
    ...
    cities: string[] = ["Алушта", "Армянськ", "Красноперекопськ", "Джанкой", "Євпаторія", "Керч", "Саки", "Сімферополь", "Судак", "Феодосія", "Ялта", "Вінниця",
...
"Старокостянтинів", "Хмельницький", "Шепетівка", "Ватутіне", "Золотоноша", "Канів", "Сміла", "Умань", "Черкаси", "Новодністровськ", "Чернівці", "Ніжин", "Прилуки", "Чернігів"
    ...
    getCities(country: string, query: string) : string[] {
        if (country !== 'Україна')
            return [];
        return this.cities.filter(item => item.toLowerCase().indexOf(query.toLowerCase()) > -1);
    }
}